    ...
    public void onMainClickManager(View v)
    {
        switch (v.getId()) {
            case R.id.bt_main_txtchange:
                if (tv_main_text.getText().equals("Hello Word!"))
                    tv_main_text.setText("Hey Android!");
                else
                    tv_main_text.setText("Hello Word!");
                break;
            ...
            case R.id.bt_main_startTH:
                if (bt_main_startTH.getText().equals("Thread GO")) {
                    ...
                    Toast.makeText(this, "Activation du Thread !",
                            Toast.LENGTH_SHORT).show();
                } else {
                    monThread.Stop();
                    Toast.makeText(this, "Désactivation du Thread !",
                            Toast.LENGTH_SHORT).show();
